...
public class MybatisPlusGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.mtlaa.mychat.user");//自定义包的路径
...
//        strategyConfig.setTablePrefix("t_");
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://dl:3306/mychat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}