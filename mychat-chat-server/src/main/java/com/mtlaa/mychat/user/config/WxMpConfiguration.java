package com.mtlaa.mychat.user.config;

import com.mtlaa.mychat.user.service.handler.LogHandler;
import com.mtlaa.mychat.user.service.handler.MsgHandler;
import com.mtlaa.mychat.user.service.handler.ScanHandler;
import com.mtlaa.mychat.user.service.handler.SubscribeHandler;
